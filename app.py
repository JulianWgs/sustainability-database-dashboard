...
database_path = "https://raw.githubusercontent.com/JulianWgs/sustainability-goals-review/main/"
...
df_data = pd.read_csv(database_path + "data.csv")
df_resources = pd.read_csv(database_path + "resources.csv").drop(columns=["date"])
